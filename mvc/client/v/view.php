...
$form = new FormBuilder(false, '/client/update');
...
echo $form->AddTitle('{edit existing client}');
echo $form->Build('client', $vals);
echo $form->AddSubmitButton('func', 'Update Client', array('label' => '{update client}'));
echo $form->EndForm();
